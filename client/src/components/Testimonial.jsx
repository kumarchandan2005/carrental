...
const Testimonial = () => {
       const testimonials = [
        {  name: "Emma Rodriguez",
            ...
            testimonial: "I've rented cars form various companies,but the experience with CarRental was exceptional." 
        },
        {  name: "babar",
            location: "New York, USA", 
            image: assets.testimonial_image_2, 
            testimonial: "CarRental made my trip so much essier. the car was deliveered right to my door,and the customer" 
        },
        {  name: "johnson",
            location: "aydney, Australia", 
            image: assets.testimonial_image_1, 
            testimonial: "I've rented cars form various companies,but the experience with CarRental was exceptional." 
        },
